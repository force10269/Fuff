const sampleClasses = [
  ...
  },
  {
    ...
    name: 'Kickboxing',
    description:
      'Learn the fundamentals of kickboxing and improve your fitness',
  ...
  },
  {
    ...
    name: 'Meditation',
    description:
      'Practice mindfulness and reduce stress with guided meditation',
  ...
  },
  {
    ...
    name: 'Spin',
    description:
      'Burn calories and improve your cardiovascular endurance with indoor cycling',
